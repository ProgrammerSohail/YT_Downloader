                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 lg:p-12 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col lg:flex-row gap-4 items-end">
                            <div className="flex-1 w-full">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full pl-12 pr-4 py-4 text-gray-900 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent focus:bg-white transition-all duration-200 placeholder-gray-400 text-base"
                                        autoComplete="off"
                                        value={youtubeUrl}
                            ...
                            <button
                                type="submit"
                                className={`px-8 py-4 rounded-2xl font-semibold text-white transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-indigo-500/50 shadow-lg text-base min-w-[140px] ${
                                    isLoading 
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-gray-500">
                                Supports videos, playlists, and channels from YouTube
                            </p>
                        </div>
                    </div>
                </div>
